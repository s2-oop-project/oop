...
vector<Ebook> add_ebook(vector<Ebook> Ebook_collection){
    ...
    cin>>Page;
    Ebook new_ebook;
    new_ebook.set_up(Material_name,Autor_name);
    new_ebook.set_page_number(Page);
    cout<<endl<<endl<<endl<<"secuessfully add Ebook:"<<endl<<"Ebook name:"<<new_ebook.material_name<<endl<<"Ebook autor:"<<new_ebook.autor_name<<endl<<"page number:"<<new_ebook.page_num<<endl<<endl<<"——————————————————————————————————————————————"<<endl;
...
vector<book> add_book(vector<book> book_collection){
    ...
    cin>>Page;
    book new_book;
    new_book.set_up(Material_name,Autor_name);
    new_book.set_page_number(Page);
    cout<<endl<<endl<<endl<<"secuessfully add book:"<<endl<<"Book name:"<<new_book.material_name<<endl<<"Book autor:"<<new_book.autor_name<<endl<<"page number:"<<new_book.page_num<<endl<<endl<<"——————————————————————————————————————————————"<<endl;
...
vector<DVD> add_DVD(vector<DVD> DVD_collection){
    ...
    cin>>Len;
    DVD new_DVD;
    new_DVD.set_up(Material_name,Autor_name);
    new_DVD.set_length(Len);
    cout<<endl<<endl<<endl<<"secuessfully add book:"<<endl<<"DVD name:"<<new_DVD.material_name<<endl<<"DVD autor:"<<new_DVD         .autor_name<<endl<<"Length of DVD:"<<new_DVD.length<<endl<<endl<<"——————————————————————————————————————————————"<<endl;
